# Reviewer Guide — ChainOps Commander
...
## Product objective
Diagnose RPC lag and node reliability drift.
...
print(run_pipeline_sync("ChainOps Commander", {"subject":"rpc_reliability reviewer smoke"}))
PY
```
