"""ChainOps Autopilot multi-agent reasoning core.
...
PROJECT_NAME = 'ChainOps Autopilot'
DOMAIN = 'multi-chain infrastructure operations'
AUDIENCE = 'chain infrastructure teams'
AGENT_ROLES = ['RPC Health Watcher', 'Peer Quality Analyst', 'Sync Stall Diagnoser', 'Cost-Aware Capacity Planner', 'Runbook Commander']
SIGNALS = ['rpc_p95_ms', 'missed_blocks', 'peer_churn', 'disk_growth_gb', 'region_error_rate']
SCENARIOS = ['validator sync lag', 'public RPC saturation', 'archive node disk pressure']
